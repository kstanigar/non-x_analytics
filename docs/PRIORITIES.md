...
- [ ] **Phase 7: Build Remaining Live Endpoints** ⭐ NEXT PRIORITY
  ...
  **🟡 Medium (2–4 hrs each, existing dims) — see `docs/Phase7_Medium_Tier_Plan.md`:**
  ...
  9. **MT-4: Replay Rate KPI** — new `subType=replay-rate` using `is_replay` dim on `game_start` (2–3 hrs) ⭐ NEXT
...
**Phase 7 Progress:** ~75% live data (QW1–5 ✅, MT-1 ✅, MT-2 ✅, MT-3 ✅, MT-4 next)
